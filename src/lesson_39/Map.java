...
public class Map {
    public static void main(String[] args) {
        ...
        java.util.Map<Integer, String> oldTable = new Hashtable<>(); // Устаревшая, медленная. Не рекомендуется использованию.

        java.util.Map<String, String> phoneBook = new HashMap<>();
        ...
        java.util.Map<String, String> book2 = new HashMap<>();
        ...
        /**
         Конструкторы
         * Создает пустой список пар ключ-значение 16 корзин. Коэффициент загрузки 0.75
         */
        java.util.Map<Integer, String> test = new HashMap<>();
        /**
         * Создает пустой список. 32 корзины. Коэффициент загрузки 0.75
         */
        test = new HashMap<>(32);
        /**
         * Создает пустой список. 32 корзины. Коэффициент загрузки 0.90
         */
        test = new HashMap<>(32, 0.90f);
        java.util.Map<Integer, String> otherMap = new HashMap<>();
        otherMap.put(1, "a");
